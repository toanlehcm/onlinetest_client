...
constructor(private questions:QuestionsService,private images:ImagesService,private pnotifyService: PnotifyService) { }
...
load_image(){
this.images.load().subscribe(data => {
this.results_image =(<any>data).data;
this.dtTrigger.next();
})
}
